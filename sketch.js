...
function setup() {
	...
	box_bottom = Bodies.rectangle(400,650,200,20,{isStatic:false});
	World.add(world,ground);

	box_side1 = Bodies.rectangle(300,610,20,100,{isStatic:false});
	World.add(world,ground);


	box_side2 = Bodies.rectangle(500,610,20,100,{isStatic:false});
	World.add(world,ground);
	fill("red");
	Engine.run(engine);
